//app/pay/PayFlow.js
define(['Moo', 'Pay'], function(Moo, Pay) {
	var PayFlow = new Class({
		Extends : Pay,
		initialize : function() {
	...
	Pay.gotoFlow = function() {
		...
		if (method == null || method == "99") {
			...
			formData = {
				"Login" : "LoginIndex.refundConfirmLogin",
			...
			sceneName = "LoginVerify";
			formData = {
				"Login" : "LoginIndex.voidConfirmLogin",
				"merchId" : cacheData.merchId
			};
		} else if (method == "10") {
		...
		function checkExistField(packTag) {
			if (cacheData[packTag] != null) {
				return true;
			} else if (compare("F35", "track2") || compare("F36", "track3") || compare("F40_6F12", "field4") || compare("F40_6F08", "field1") || compare("F40_6F11", "authCode") || compare("F40_6F20", "openBrh") || compare("F60.6", "paymentId") || compare("F04", "transAmount")) {
				return true;
			}
			return false;
