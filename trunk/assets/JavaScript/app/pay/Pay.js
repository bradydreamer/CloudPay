...
define(['Moo'], function(Moo) {
	...
	Pay.backupInfo = function(params) {
		...
		window.Database.insertTransData8583(ConsumptionData.dataForPayment.txnId, ConsumptionData.dataForPayment.req8583, ConsumptionData.dataForPayment.res8583);
