//app/Others/Settings/Login/LoginIndex.js
define(['Moo'], function() {
	...
	var LoginIndex = new Class({
		...
		actionAfterVerifyLogin : function(data) {
			g_loginRes = data;
		...
		//目前下面的代码是以第二种方式实现的。
		refundConfirmLogin : function(msg) {
		...
		afterConfirmLogin : function(data) {
