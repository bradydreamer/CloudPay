...
define(['Moo'], function(Moo) {
	...
	Util.formatAmountStr = function(fen) {
		fen = "" + fen;
	...
	Util.yuan2fenStr = function(yuan) {
		yuan = "" + yuan;
	...
	Util.formatDateTime = function(time) {
	...
	Util.showSceneWithLoginChecked = function(sceneName, params, sceneTitle) {
	...
	Util.clearReverseDataWithLoginChecked = function(sceneName, params, sceneTitle) {
		var data = params == null ? {} : params;
		sceneTitle = sceneTitle == null ? "" : sceneTitle;
	...
	Util.showMisposWithLoginChecked = function(params) {
	...
	Util.showCouponWithLoginChecked = function(params) {
		var data = JSON.parse(params);
	...
	Util.showSceneWithSigninChecked = function(sceneName, params, sceneTitle) {
		var data = params == null ? {} : params;
		sceneTitle = sceneTitle == null ? "" : sceneTitle;
	...
	Util.exeActionWithLoginChecked = function(actionWithLoginNeeded, needNotGoBack) {
		var merchInfo;
	...
	Util.exeActionWithSigninChecked = function(actionWithLoginNeeded, needNotGoBack) {
	...
	Util.stringlen = function(str) {
		return str.replace(/[^\x00-\xff]/g, "aa").length;
	};

	Util.getTransType = function(transTypeKey) {
	...
	Util.getPayTypeCode = function(payTypeKey) {
	...
	Util.payTypeCode2Name = function(payTypeCode) {
		if ("9100" == payTypeCode) {
			return "现金";
	...
	Util.isReverseToday = function(transDate) {
	...
	Util.showNoticeIsPaying = function() {
	...
	Util.getProductInfo = function(data, open_brh, payment_id) {
