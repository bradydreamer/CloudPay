//app/Common/NearField.js
define(['Moo', 'Scene'], function(Moo, Scene) {
	var NearField = new Class({
		initialize : function() {
		...
		processReceivedData : function(data) {
			...
			if ("delVoucher" == actionPurpose) {
				...
				if ("" == window.util.payTypeCode2Name(payType) || payType == window.util.getPayTypeCode("koolcloud_cash") || payType == window.util.getPayTypeCode("coupon")) {
