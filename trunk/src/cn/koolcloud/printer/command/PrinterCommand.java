package cn.koolcloud.printer.command;

public class PrinterCommand {
	public static final int CUT_HALF = 0x00;
	public static final int CUT_TOTAL = 0x01;
	...
	public static byte[] getCmdCutPaper(int cutmode) {
		
		byte mode = 0x41;//全切   0x42 半切
		if(cutmode == CUT_HALF)
			mode = 0x42;
		else if(cutmode == CUT_TOTAL)
			mode = 0x41;
		else {
			return null;
		}
		
		byte[] cmds = { 0x1D, 0x56, mode,0x00 };
		return cmds;
	}
