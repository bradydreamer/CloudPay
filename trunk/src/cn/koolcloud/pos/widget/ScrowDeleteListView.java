 ...
 * 
 */
public class ScrowDeleteListView extends ListView {
	/**
	...
	public ScrowDeleteListView(Context context) {
		this(context, null);
	}

	public ScrowDeleteListView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ScrowDeleteListView(Context context, AttributeSet attrs, int defStyle) {
