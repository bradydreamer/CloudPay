...
public class APDefine {
	...
	// public static final String APPSERVER =
	// "http://aop.koolcloud.cn/apmp/mobile.action";
	/**
	...
	// "";

	// for develop,test,show
	public static final String MODULUS = "";

	// for develop,test
	// public static final String TPDU = "6006150000";
	public static final String TPDU = "6006140000";

	// for show
	// public static final String TPDU = "6006140000";
	// for produce
	// public static final String TPDU = "6017100000";
