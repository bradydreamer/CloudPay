...
include $(CLEAR_VARS)
LOCAL_MODULE    := wizarpos_magnetic_stripe_reader
LOCAL_SRC_FILES := hal_sys_log.c
...
include $(CLEAR_VARS)
LOCAL_MODULE    := wizarpos_led
LOCAL_SRC_FILES := hal_sys_log.c
LOCAL_SRC_FILES += led_jni_register.cpp
LOCAL_SRC_FILES += led_jni_interface.cpp
LOCAL_LDLIBS := -lm -llog
include $(BUILD_SHARED_LIBRARY)