...
-keepclassmembers class cn.koolcloud.pos.JavaScriptEngine$JSResponser {
   	<methods>;
}

#-keepclassmembers class cn.koolcloud.pos.JavaScriptEngine {
#   	<methods>;
#}
...
-keep public class cn.koolcloud.pos.JavaScriptEngine$JSResponser
#-keep public class cn.koolcloud.pos.JavaScriptEngine
#-keep public class cn.koolcloud.pos.ClientEngine
-keep public class * extends android.app.Activity
-keep public class * extends BaseController
-keep public class * extends BaseHomeController
-keep public class * extends WelcomeScreen
